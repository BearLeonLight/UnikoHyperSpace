...
package com.unikohyperspace.unikohyperspaceapi.listener;

import com.unikohyperspace.api.inventory.gui.GUI;
import com.unikohyperspace.core.inventory.UInventoryListenerHandler;
...
public final class InventoryListener
    ...
    private void executeListener(final @NotNull GUI gui, @NotNull InventoryEvent event) {
        ...
        if (UInventoryListenerHandler.Helper.isSynchronous(gui))
            ...
            // 異步調用
            thread.runTaskAsynchronously(UnikoHyperSpaceAPI.getInstance());
